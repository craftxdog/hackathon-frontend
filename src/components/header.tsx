        ...
        <ContainerElement>
          <div className='relative px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between w-full'>
            <div className="flex items-center">
              ...
              <Link className='ml-4 lg:ml-0' to="/nosotros" >
            ...
            <div className='flex items-center'>
              <Button variant="ghost" size="icon" className='mr-2' aria-label='Actividad'>
                <Activity className='h-6 w-6' />
                <span className='sr-only'>Actividad</span>
              </Button>
              <Button variant="ghost" size="icon" className='mr-6' aria-label='Toggle Theme' onClick={() => setTheme(theme === 'dark' ? 'ligth' : 'dark')}>
